...
<!-- Mirrored from easybook.kwst.net/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Feb 2022 19:29:43 GMT -->
<head>
        <!--=============== basic  ===============-->
        <meta charset="UTF-8">
        ...
        <!--=============== css  ===============-->
        <link type="text/css" rel="stylesheet" href="{{ asset('website') }}/css/reset.css">
        <link type="text/css" rel="stylesheet" href="{{ asset('website') }}/css/plugins.css">
        <link type="text/css" rel="stylesheet" href="{{ asset('website') }}/css/style.css">
        <link type="text/css" rel="stylesheet" href="{{ asset('website') }}/css/color.css">
        <!--=============== favicons ===============-->
    ...
    <body>
        ...
        <script type="text/javascript"src="{{ asset('website') }}/js/scripts.js"></script>
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDwJSRi0zFjDemECmFl9JtRj1FY7TiTRRo&amp;libraries=places&amp;callback=initAutocomplete"></script>
        <script type="text/javascript"src="{{ asset('website') }}/js/map-single.js"></script>
        @livewireScripts
    </body>

<!-- Mirrored from easybook.kwst.net/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 22 Feb 2022 19:31:27 GMT -->
</html>