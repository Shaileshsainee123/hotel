                        ...
                        <div class="footer-carousel-wrap fl-wrap">
                            <div class="footer-carousel fl-wrap">
                                ...
                                <div class="footer-carousel-item">
                                    <a href="#"><img src="{{ asset('website') }}/images/partners/1.png" alt=""></a>
                                </div>
                                <!--footer-carousel-item end-->
                                <!--footer-carousel-item-->
                                <div class="footer-carousel-item">
                                    <a href="#"><img src="{{ asset('website') }}/images/partners/2.png" alt=""></a>
                                </div>
                                <!--footer-carousel-item end-->
                                <!--footer-carousel-item-->
                                <div class="footer-carousel-item">
                                    <a href="#"><img src="{{ asset('website') }}/images/partners/3.png" alt=""></a>
                                </div>
                                <!--footer-carousel-item end-->
                                <!--footer-carousel-item-->
                                <div class="footer-carousel-item">
                                    <a href="#"><img src="{{ asset('website') }}/images/partners/4.png" alt=""></a>
                                </div>
                                <!--footer-carousel-item end-->
                                <!--footer-carousel-item-->
                                <div class="footer-carousel-item">
                                    <a href="#"><img src="{{ asset('website') }}/images/partners/5.png" alt=""></a>
                                </div>
                                <!--footer-carousel-item end-->
                                <!--footer-carousel-item-->
                                <div class="footer-carousel-item">
                                    <a href="#"><img src="{{ asset('website') }}/images/partners/6.png" alt=""></a>
                                </div>
                                <!--footer-carousel-item end-->
                            </div>
                ...
                <div class="col-md-4">
                    <div class="footer-widget fl-wrap">
                        ...
                        <div class="widget-posts fl-wrap">
                            <ul>
                                <li class="clearfix">
                                    <a href="#"  class="widget-posts-img"><img src="{{ asset('website') }}/images/all/1.jpg" class="respimg" alt=""></a>
                                ...
                                <li class="clearfix">
                                    <a href="#"  class="widget-posts-img"><img src="{{ asset('website') }}/images/all/2.jpg" class="respimg" alt=""></a>
                                    <div class="widget-posts-descr">
                                ...
                                <li class="clearfix">
                                    <a href="#"  class="widget-posts-img"><img src="{{ asset('website') }}/images/all/3.jpg" class="respimg" alt=""></a>
                                    <div class="widget-posts-descr">
