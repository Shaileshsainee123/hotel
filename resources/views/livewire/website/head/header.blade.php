<header class="main-header">
    ...
    <div class="header-top fl-wrap">
        <div class="container">
            ...
            <div class="lang-wrap">
                <div class="show-lang"><img src="{{ asset('website') }}/images/lan/1.png" alt=""> <span>Eng</span><i class="fa fa-caret-down"></i></div>
                <ul class="lang-tooltip green-bg">
                    <li><a href="#"><img src="{{ asset('website') }}/images/lan/4.png" alt=""> De</a></li>
                    <li><a href="#"><img src="{{ asset('website') }}/images/lan/5.png" alt=""> It</a></li>
                    <li><a href="#"><img src="{{ asset('website') }}/images/lan/2.png" alt=""> Fr</a></li>
                    <li><a href="#"><img src="{{ asset('website') }}/images/lan/3.png" alt=""> Es</a></li>
                </ul>
            </div>
        ...
        <div class="container">
            ...
            <div class="header-user-menu">
                <div class="header-user-name">
                    <span><img src="{{ asset('website') }}/images/avatar/4.jpg" alt=""></span>
                    My account
                </div>
                <ul>
            ...
            <div class="wishlist-wrap scrollbar-inner novis_wishlist">
                <div class="box-widget-content">
                    <div class="widget-posts fl-wrap">
                        <ul>
                            <li class="clearfix">
                                <a href="#"  class="widget-posts-img"><img src="{{ asset('website') }}/images/gal/7.jpg" class="respimg" alt=""></a>
                            ...
                            <li class="clearfix">
                                <a href="#"  class="widget-posts-img"><img src="{{ asset('website') }}/images/gal/8.jpg" class="respimg" alt=""></a>
                                <div class="widget-posts-descr">
                            ...
                            <li class="clearfix">
                                <a href="#"  class="widget-posts-img"><img src="{{ asset('website') }}/images/gal/9.jpg" class="respimg" alt=""></a>
                                <div class="widget-posts-descr">
